...
//     Widget categoriesSection(List<ProductModel> data) {
//       return Column(
//         children: [
//           Container(
...
//     Widget contentPopular(List<ProductModel> data) {
//       return Container(
...
//                     header(),
//                     searchingBox(),
//                     categoriesSection(snapshot.data!),
//                     contentPopular(snapshot.data!),
//                   ],
//                 ),
//               ],
//             );
